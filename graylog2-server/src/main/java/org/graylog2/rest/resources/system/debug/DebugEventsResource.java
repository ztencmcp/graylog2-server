...
public class DebugEventsResource extends RestResource {
    ...
    @GET
    @Path("/cluster")
    @ApiOperation(value = "Show last received cluster debug event.", response = ClusterEvent.class)
    public ClusterEvent showLastClusterDebugEvent() {
        return DebugEventHolder.getClusterEvent();
    }
    ...
    public DebugEvent showLastDebugEvent() {
        return DebugEventHolder.getDebugEvent();
    }
}
